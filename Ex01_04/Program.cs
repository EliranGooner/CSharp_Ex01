...
namespace Ex01_04
{
    class Program
    {
        public static void Main()
        {
            ...
            printInputAnalysis(userInput, isPalindrome(userInput), isDivisiveBy3(userInput), getAmountOfUppercaseLetters(userInput));
        }
        ...
        private static bool isDivisiveBy3(string i_UserInput)
        {
        ...
        private static void printInputAnalysis(string i_UserInput, bool i_IsPalindrome, bool i_IsDivisiveBy3,
                                               int i_AmountOfUppercaseLetters)
        {
            ...
            if(isDigitsOrLettersOnly(i_UserInput, "Digits"))
            {
                if(i_IsDivisiveBy3)
                {
                    outputMessage.Append("The input is divisive by 3\n");
                }
                else
                {
                    outputMessage.Append("The input isn't divisive by 3\n");
                }
            }
            else
            {
